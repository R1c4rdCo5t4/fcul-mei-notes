...
## Contents
### 1st Semester
- [**DS - Design de Software** (Software Design)](./1sem/DS/)
- [**SS - Segurança de Software** (Software Security)](./1sem/SS/)
- [**TFD - Tolerância a Faltas Distribuída** (Distributed Fault Tolerance)](./1sem/TFD/)
- [**FLP - Fundamentos de Linguagens de Programação** (Fundamentals of Programming Languages)](./1sem/FLP/)
- [**CM - Computação Móvel** (Mobile Computing)](./1sem/CM/)
